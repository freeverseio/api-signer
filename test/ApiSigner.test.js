...
it('should calculate the digest for recceiptDigest', () => {
...
it('should create signature for AssetOperationRecceipt', () => {
  ...
  const expected = '0x3aa5a1390e79668331eb92842168d88cdbd94a484a31c4b79fce60a377bbdacc4ce18b5376b72e87a64661cc98e51359b1f42e8ec5ccdff60274b6690b0211ec1c';
  const receipt = {
    results: ['{"result":"success"}'],
    ops: [`{}`,`{2}`,],
    universeId: 1,
